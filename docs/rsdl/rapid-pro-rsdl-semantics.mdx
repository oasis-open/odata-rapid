...
If the same type is used as a type on a multi-value and - prefixed with a `*` - as the type of a property of a structured type (i.e. a navigation property in CSDL),
the appropriate navigation property bindings get created.
The `Company` type in the following example has properties `ceo` and `employees` of the same type `Employee`, marked as a "reference" by prefixing the type with a `*`.
...
<EntityType Name="Company">
  ...
  <Property Name="stockSymbol" Type="Edm.String" Nullable="false" />
  <Property Name="name" Type="Edm.String" Nullable="false" />
   <NavigationProperty Name="ceo" Type="Model.Employee" />
