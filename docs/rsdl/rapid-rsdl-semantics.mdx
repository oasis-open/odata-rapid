...
> DRAFT
> Initial Draft. June 2022

The semantic of RSDL (RAPID Schema Definition Language) can be described by mapping
syntactical constructs described in [RSDL ABNF](../rsdl-abnf) to equivalent runtime [Service Definition](../spec/rapid-pro-resource_description.md) constructs.

Please refer to [RSDL ABNF](../rsdl-abnf) for the syntactical constructs of RSDL.
