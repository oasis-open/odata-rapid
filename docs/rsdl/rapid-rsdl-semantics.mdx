...
syntactical constructs described in [rapid-pro-rsdl-abnf](rsdl-abnf) to equivalent runtime [Service Definition](../spec/rapid-pro-resource_description.md) constructs.

Please refer to [rapid-pro-rsdl-abnf](./rsdl-abnf) for the syntactical constructs of RSDL.
