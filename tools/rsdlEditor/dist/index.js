(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.rsdlEditor = {}));
...
`.trimStart();
    ...
    function initRsdlEditor(domElement, onRsdlUpdated) {
        let timeout;
        ...
        const updateContent = (rsdl) => {
            const transaction = view.state.update({ changes: { from: 0, to: view.state.doc.length, insert: rsdl } });
    ...
    exports.initRsdlEditor = initRsdlEditor;
