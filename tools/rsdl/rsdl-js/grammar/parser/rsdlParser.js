...
import rsdlListener from './rsdlListener.js';
...
export default class rsdlParser extends antlr4.Parser {

    static grammarFileName = "rsdl.g4";
    static literalNames = [ null, "'namespace'", "'include'", "'as'", "'type'", 
                            "'{'", "'}'", "'extends'", "':'", "'['", "']'", 
                            "'Boolean'", "'Date'", "'DateTime'", "'Decimal'", 
                            "'('", "','", "')'", "'Double'", "'Duration'", 
                            "'Integer'", "'String'", "'TimeOfDay'", "'enum'", 
                            "'flags'", "'typedef'", "'service'", "'true'", 
                            "'false'", "'null'", "'.'", "'/'", "'abstract'", 
                            "'action'", "'function'", "'key'", "'?'" ];
    static symbolicNames = [ null, null, null, null, null, null, null, null, 
                             ...
                             null, null, null, null, null, null, null, null, 
                             null, null, null, null, null, null, null, null, 
                             "ABSTRACT", "ACTION", "FUNCTION", "KEY", "NULLABLE", 
                             "NUMBER", "STRING", "EDM", "ID", "QID", "TID", 
                             "DOC_COMMENT", "LINE_COMMENT", "WS" ];
    static ruleNames = [ "model", "namespace", "include", "modelElement", 
                         "structuredType", "baseType", "typeMember", "property", 
                         "propertyName", "typeReference", "typeName", "builtInType", 
                         "edmType", "operation", "parameter", "returnType", 
                         "enumType", "enumKind", "enumMember", "typeDefinition", 
                         "service", "serviceMember", "entitySet", "singleton", 
                         "serviceOperation", "annotation", "value", "arr", 
                         "item", "obj", "pair", "name", "path", "qualifiedName" ];

    constructor(input) {
        super(input);
        this._interp = new antlr4.atn.ParserATNSimulator(this, atn, decisionsToDFA, sharedContextCache);
        this.ruleNames = rsdlParser.ruleNames;
        this.literalNames = rsdlParser.literalNames;
        this.symbolicNames = rsdlParser.symbolicNames;
    }
	...
	edmType() {
	    let localctx = new EdmTypeContext(this, this._ctx, this.state);
	...
	enumKind() {
	    let localctx = new EnumKindContext(this, this._ctx, this.state);
	...
	serviceMember() {
	    let localctx = new ServiceMemberContext(this, this._ctx, this.state);
	...
	entitySet() {
	    let localctx = new EntitySetContext(this, this._ctx, this.state);
	...
	singleton() {
	    let localctx = new SingletonContext(this, this._ctx, this.state);
	...
	serviceOperation() {
	    let localctx = new ServiceOperationContext(this, this._ctx, this.state);
...
class TypeMemberContext extends antlr4.ParserRuleContext {
...
class SingleContext extends TypeReferenceContext {
...
class ArrayContext extends TypeReferenceContext {
...
class EdmTypeContext extends antlr4.ParserRuleContext {
...
class EnumKindContext extends antlr4.ParserRuleContext {
...
class ServiceMemberContext extends antlr4.ParserRuleContext {
...
class EntitySetContext extends antlr4.ParserRuleContext {
...
class SingletonContext extends antlr4.ParserRuleContext {
...
class ServiceOperationContext extends antlr4.ParserRuleContext {
