...
rsdlParser.prototype.model = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 5)) & ~0x1f) == 0 && ((1 << (_la - 5)) & ((1 << (rsdlParser.T__4 - 5)) | (1 << (rsdlParser.T__23 - 5)) | (1 << (rsdlParser.T__24 - 5)) | (1 << (rsdlParser.T__25 - 5)) | (1 << (rsdlParser.T__26 - 5)) | (1 << (rsdlParser.T__27 - 5)) | (1 << (rsdlParser.ABSTRACT - 5)))) !== 0)) {
            this.state = 73;
            this.modelElement();
            this.state = 78;
            this._errHandler.sync(this);
...
rsdlParser.prototype.structuredType = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (rsdlParser.T__27 - 28)) | (1 << (rsdlParser.ACTION - 28)) | (1 << (rsdlParser.FUNCTION - 28)) | (1 << (rsdlParser.KEY - 28)) | (1 << (rsdlParser.ID - 28)))) !== 0)) {
            this.state = 118;
            this.typeMember();
            this.state = 123;
            this._errHandler.sync(this);
...
rsdlParser.prototype.operation = function() {
    ...
    try {
        ...
        case 1:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(_la===rsdlParser.T__27 || _la===rsdlParser.ID) {
                this.state = 197;
                this.parameter();
                this.state = 202;
                this._errHandler.sync(this);
                _la = this._input.LA(1);
                while(_la===rsdlParser.T__16) {
                    this.state = 198;
                    this.match(rsdlParser.T__16);
                    this.state = 199;
                    this.parameter();
...
rsdlParser.prototype.enumType = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===rsdlParser.T__27 || _la===rsdlParser.ID) {
            this.state = 262;
            this.enumMember();
            this.state = 267;
            this._errHandler.sync(this);
...
rsdlParser.prototype.enumKind = function() {
    ...
    try {
        ...
        this.state = 270;
        _la = this._input.LA(1);
        if(!(_la===rsdlParser.T__23 || _la===rsdlParser.T__24)) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
rsdlParser.prototype.service = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (rsdlParser.T__27 - 28)) | (1 << (rsdlParser.ACTION - 28)) | (1 << (rsdlParser.FUNCTION - 28)) | (1 << (rsdlParser.ID - 28)))) !== 0)) {
            this.state = 302;
            this.serviceMember();
            this.state = 307;
            this._errHandler.sync(this);
