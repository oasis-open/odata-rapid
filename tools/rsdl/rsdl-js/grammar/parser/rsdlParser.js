...
var literalNames = [ null, "'namespace'", "'.'", "'include'", "'as'", "'type'", 
                     ...
                     "'Integer'", "'String'", "'TimeOfDay'", "'('", "','", 
                     "')'", "'enum'", "'flags'", "'service'", "'@'", "'true'", 
                     "'false'", "'null'", "'/'", "'abstract'", "'action'", 
                     "'function'", "'key'", "'?'" ];
...
rsdlParser.prototype.model = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 5)) & ~0x1f) == 0 && ((1 << (_la - 5)) & ((1 << (rsdlParser.T__4 - 5)) | (1 << (rsdlParser.T__23 - 5)) | (1 << (rsdlParser.T__24 - 5)) | (1 << (rsdlParser.T__25 - 5)) | (1 << (rsdlParser.T__26 - 5)) | (1 << (rsdlParser.ABSTRACT - 5)))) !== 0)) {
            this.state = 71;
            this.modelElement();
            this.state = 76;
            this._errHandler.sync(this);
...
rsdlParser.prototype.builtInType = function() {
    ...
    try {
        ...
        this.state = 162;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << rsdlParser.T__11) | (1 << rsdlParser.T__12) | (1 << rsdlParser.T__13) | (1 << rsdlParser.T__14) | (1 << rsdlParser.T__15) | (1 << rsdlParser.T__16) | (1 << rsdlParser.T__17) | (1 << rsdlParser.T__18) | (1 << rsdlParser.T__19))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
