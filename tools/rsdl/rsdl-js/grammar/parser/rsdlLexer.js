...
rsdlLexer.T__30 = 31;
rsdlLexer.T__31 = 32;
rsdlLexer.ABSTRACT = 33;
rsdlLexer.ACTION = 34;
rsdlLexer.FUNCTION = 35;
rsdlLexer.KEY = 36;
rsdlLexer.NULLABLE = 37;
rsdlLexer.NUMBER = 38;
rsdlLexer.STRING = 39;
rsdlLexer.ID = 40;
rsdlLexer.LINE_COMMENT = 41;
rsdlLexer.WS = 42;
...
rsdlLexer.prototype.literalNames = [ null, "'namespace'", "'include'", "'as'", 
                                     "'type'", "'{'", "'}'", "'extends'", 
                                     "':'", "'['", "']'", "'Boolean'", "'Date'", 
                                     "'DateTime'", "'Decimal'", "'('", "','", 
                                     "')'", "'Double'", "'Duration'", "'Integer'", 
                                     "'String'", "'TimeOfDay'", "'enum'", 
                                     "'flags'", "'typedef'", "'service'", 
                                     "'@'", "'true'", "'false'", "'null'", 
                                     "'.'", "'/'", "'abstract'", "'action'", 
                                     "'function'", "'key'", "'?'" ];
...
rsdlLexer.prototype.symbolicNames = [ null, null, null, null, null, null, 
                                      ...
                                      null, null, null, null, null, null, 
                                      null, null, null, null, null, null, 
                                      null, null, null, "ABSTRACT", "ACTION", 
...
rsdlLexer.prototype.ruleNames = [ "T__0", "T__1", "T__2", "T__3", "T__4", 
                                  ...
                                  "T__30", "T__31", "ABSTRACT", "ACTION", 
                                  "FUNCTION", "KEY", "NULLABLE", "NUMBER", 
                                  "INT", "EXP", "STRING", "ESC", "UNICODE", 
                                  "HEX", "SAFECODEPOINT", "ID", "SIMPLE", 
                                  "LINE_COMMENT", "WS" ];
