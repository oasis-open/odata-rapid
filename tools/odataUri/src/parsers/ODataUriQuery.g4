...
queryOption: filterOption | selectOption | expandOption | orderByOption | topOption | skipOption;
...
selectFieldList: selectField | selectField COMMA selectFieldList;
expandFieldList: expandField | expandField COMMA expandFieldList; // distinguish expand and select fields to make semantic validation easier (expand only supports navprops)
...
basicExpression: NUMBER | STRING | BOOLEAN | identifier | parenExpression;
